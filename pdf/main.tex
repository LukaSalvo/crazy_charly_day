...
\begin{titlepage}
    ...
    \vspace{1cm}
\textbf{Lien vers le site :}\\
\href{https://front.cesareuh.fr/}{https://front.cesareuh.fr/}
\vspace{1cm}

    \vfill
    {\large Réalisé par :\\ \textbf{Graff Mathieu}, \textbf{Salzard Manech}, \textbf{Andrieu Paul }, \textbf{Salvo Luka} \par}
